...
from services.phonebook_analyzer import PhoneBookAnalyzer
...
def main():
    analyzer = PhoneBookAnalyzer('/Users/dgsw12/Desktop/미유고/PhoneBook/step8/data/phone_book.csv')
