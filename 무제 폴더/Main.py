...
def main():
    Princess = PrincessMaker('/Users/dgsw12/Desktop/미유고/Stats.csv')
    Story = MainStory
    ...
    plus_stats1 = [['Stamina', 'MuscularStrength'], ['Intellect', 'Morality'],
    ...
    plus_stats2 = [['Stamina', 'MuscularStrength'], ['Intellect', 'Morality'], 
                    ['Stamina', 'Tenacity'], ['Attractiveness', 'Dignity']]
    ...
    plus_stats6 = [['Stamina', 'MuscularStrength'], ['Morality'], None, ['Attractiveness']]
    ...
    plus_stats7 = [['Stamina', 'MuscularStrength'], ['Intellect', 'Morality', 'Dignity'], ['Intellect', 'Morality', 'Dignity'], ['Attractiveness', 'Attractiveness', 'Attractiveness']]
    ...
    after_option9 = [1,2,3,4]
    plus_stats9 = ['Stamina','Stamina','Stamina','Stamina']
    minus_stats9 = ['Stamina','Stamina','Stamina','Stamina']
    ...
    after_option10 = [1,2,3,4]
    plus_stats10 = ['Stamina','Stamina','Stamina','Stamina']
    minus_stats10 = ['Stamina','Stamina','Stamina','Stamina']
    ...
    after_option11 = [1,2,3,4]
    plus_stats11 = ['Stamina','Stamina','Stamina','Stamina']
    minus_stats11 = ['Stamina','Stamina','Stamina','Stamina']
    ...
    after_option12 = [1,2,3,4]
    plus_stats12 = ['Stamina','Stamina','Stamina','Stamina']
    minus_stats12 = ['Stamina','Stamina','Stamina','Stamina']
    ...
    after_option13 = [1,2,3,4]
    plus_stats13 = ['Stamina','Stamina','Stamina','Stamina']
    minus_stats13 = ['Stamina','Stamina','Stamina','Stamina']
    ...
    after_option14 = [1,2,3,4]
    plus_stats14 = ['Stamina','Stamina','Stamina','Stamina']
    minus_stats14 = ['Stamina','Stamina','Stamina','Stamina']
